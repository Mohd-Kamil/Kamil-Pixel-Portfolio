...
export default function Skills() {
  ...
  const skillsMap = {
    frontend: ["React", "Next.js", "Bootstrap", "Tailwind", "Framer Motion", "Angular","HTML/CSS/JS"],
    backend: ["Django", "Flask", "Node.js", "Firebase", "Supabase","Express.js","FastAPI", "MongoDB","MySQL", "Python", "Restful API"],
    tools: ["Git", "VSCode", "Figma" , "GitHub", "WordPress", "Spline" ,"Netlify", "Cursor AI", "Framer", "Shopify","Canva","Replit","Z coder", "Stitch", "Lovable AI", "Gemini AI", "Leonardo AI", "ChatGPT", "Bubble.io", "N8N"],
