        ...
        <div className="max-w-[1000px] p-3 overflow-y-auto max-h-[600px] w-full text-black flex flex-col relative px-5 pt-3 sm:gap-4">
            <div className="flex flex-col justify-center items-center sm:flex-row font-bold gap-2 relative">
                 ...
                 <div className="flex flex-row gap-2 mt-2 items-end">
                    <a href="mailto:mohkamil.info@gmail.com" target="_blank"><img src={MailIcon} className= "hover:scale-110 w-8 h-8 cursor-pointer" ></img></a>
                    <a href="https://github.com/Mohd-Kamil/" target="_blank"><img src={Github} className= "hover:scale-110 w-8 h-8  cursor-pointer" ></img></a>
                    <a href="https://www.linkedin.com/in/mohd-kamil-/" target="_blank"><img src={LinkedIn} className= "hover:scale-110 w-8 h-8 cursor-pointer" ></img></a>
                </div>
                 </div> 
