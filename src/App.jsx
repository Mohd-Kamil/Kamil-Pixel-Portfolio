    ...
    <>
      ...
      {booted && (
        <div className="h-screen cursor w-screen overflow-hidden relative">
          ...
          <StickyNote defaultText="Im Kamil! A Web developer & Designer blending modern code with nostalgic pixels."
           color="bg-yellow-300"/>
